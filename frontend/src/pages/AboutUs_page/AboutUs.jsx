    ...
    >
      ...
      <div className="about-content">
        <div className="about-image-wrapper">
          <img src={logo} alt="Cloudrule Technology" className="about-image" />
        </div>
        <div className="about-text-wrapper">
          ...
          <p className="about-description">
            ...
            We also empower school and college students through industry-focused
            training, internships, and real-world projects to build skilled
            professionals.
          </p>
        </div>
      </div>
      ...
      <div className="about-content mission-section">
        <div className="about-text-wrapper">
          ...
          <p className="about-description">
            ...
            industry-relevant skills through hands-on learning,bridge the gap
            between academia and industry, and build long-term strategic
            partnerships.
          </p>
        </div>
        <div className="about-image-wrapper">
