        ...
        <div className="relative min-h-[90vh] flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 pt-20">
          ...
          <div className={`relative z-10 text-center max-w-5xl mx-auto space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex items-center justify-center gap-4 animate-fade-in" style={{ animationDelay: '500ms' }}>
              <div className="h-px bg-gradient-to-r from-transparent to-black/20 animate-expand-right"></div>
              <div className="w-2 h-2 rounded-full bg-black/40 animate-pulse"></div>
              <div className="h-px bg-gradient-to-l from-transparent to-black/20 animate-expand-left"></div>
            </div>

            {/* Subheading */}
            <p className="text-lg sm:text-xl md:text-2xl text-black/60 max-w-3xl mx-auto leading-relaxed font-medium animate-fade-in-up" style={{ animationDelay: '700ms' }}>
